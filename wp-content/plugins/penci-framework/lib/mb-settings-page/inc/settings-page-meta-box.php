...
class MB_Settings_Page_Meta_Box extends RW_Meta_Box {
	...
	public function is_edit_screen( $screen = null ) {
		...
		$settings_pages = isset( $this->meta_box['settings_pages'] ) ? $this->meta_box['settings_pages'] : array();
		$id             = isset( $this->page_args['id'] ) ? $this->page_args['id'] : '';

		return in_array( $id, $settings_pages );
	}
}
